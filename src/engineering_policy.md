...
---
### 補足
- チームがどういう職種のメンバーで構成されているかでエンジニアの求められる役割は多少変化する
  * 例えば、POが不在であったり、デザイナーがHTML/CSSを書けたりすれば、エンジニアは画面コーディングをする必要がないなど
* その状況に依存しない普遍的な定義が上の通りになっている

---
### このToBeへと続く道から外れず「目的」を達成していくための **価値** と **原則** を定義していく
