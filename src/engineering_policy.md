...
> そのようなソフトウェアシステムを開発する役割を担っているソフトウェアエンジニアには、**善をなすことも害をなすこともできる多大なる機会があり**また、**他者が善をなすことも害をなすことも可能にする大きな機会がある**。
...
---
### どういったときにどうやって原則を適用すべきか（具体例を挙げながら）
